...
<head>
<title><bean:message key="searchservices.title"/></title>
<html:base/>
</head>
<body>  

<html:form action="/searchServiceRedirect.do" focus="serviceName">
...
<html:hidden property="currentpage" value="search_services"/> 
<html:hidden property="serviceId" value=""/> 
