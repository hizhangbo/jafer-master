 ...
 */
public class InvalidLengthException extends RegistryExceptionImpl
{

    /**
     * Constructor
     * @param fieldName Field validated
     * @param maxlength max characters
     */
    public InvalidLengthException(String fieldName, int maxlength)
    {
        super(fieldName + " can only have a maximum of " + maxlength +" characters");
    }
}
