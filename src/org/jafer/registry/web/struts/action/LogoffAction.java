 ...
 */
public final class LogoffAction extends JaferRegistryAction
{
            ...
            throws RegistryException, IOException, ServletException
    {
        ...
        // remove the username and credential from the session to log off
        session.removeAttribute(SessionKeys.USERNAME);
        session.removeAttribute(SessionKeys.CREDENTIAL);
        session.removeAttribute(SessionKeys.SERVICE_MANAGER);
        addInfoMessage("welcome.logoff");
