 ...
 */
public final class SearchServiceAction extends JaferRegistryAction
{
            ...
            throws RegistryException, IOException, ServletException
    {
        ...
        String name = (String) dynaForm.get(ParameterKeys.SERVICE_NAME);
        ...
        List services = servLoc.findService(null,name,categories,protocols,true);
        
        if(services.isEmpty())
        {
            dynaForm.set(ParameterKeys.FOUND_SERVICES,null);
        }
        else
        {
            dynaForm.set(ParameterKeys.FOUND_SERVICES,services);
        } 
