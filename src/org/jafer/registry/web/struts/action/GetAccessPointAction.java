 ...
 */
public final class GetAccessPointAction extends JaferRegistryAction
{
            ...
            throws RegistryException, IOException, ServletException
    {
        ...
        {
            dynaForm.set(ParameterKeys.ACCESS_POINT_URL,service.getWSDLUrl(protocol));
        }
        else
        {
            dynaForm.set(ParameterKeys.ACCESS_POINT_URL,service.getAccessUrl(protocol));
        }
