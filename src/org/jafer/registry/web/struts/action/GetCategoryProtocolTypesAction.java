 ...
 */
public final class GetCategoryProtocolTypesAction extends JaferRegistryAction
{
    /**
     * Execute the action
     * 
            ...
            throws RegistryException, IOException, ServletException
    {
        ...
        // set the list of protocol types
        dynaForm.set(ParameterKeys.PROTOCOL_TYPES,ProtocolTypesDisplayLink.getDisplayKeys());
        // set the list of category types
        dynaForm.set(ParameterKeys.CATEGORY_TYPES,CategoryTypesDisplayLink.getDisplayKeys());
