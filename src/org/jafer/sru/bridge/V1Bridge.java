...
public class V1Bridge
{
    ...
    public String createExplainDiagnosticResponse(String code, String message, String details, Exception exc)
    {
        try
        {
            DiagnosticType diagostic = createDiagnostics(code, message, details, exc);
            DiagnosticsType diagostics = new DiagnosticsType();
            diagostics.setDiagnostic(new DiagnosticType[]{diagostic});
            if (diagostics != null)
            {
                ...
                ser.serialize(diagQName, null, diagostics, new SerializationContext(diagWriter));
