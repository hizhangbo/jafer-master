...
/**
 * This class tests the SRUBinding class
 */
public class SRUBindingTest extends TestCase
{

    /**
     * Simple test to ensure we can search using SRU bridge
     */
    public void testSimpleSearch()
    {
        ...
        {
            // create the binding
            SRUBinding binding = new SRUBinding("http://z3950.loc.gov:7090/voyager");
            // create the query
    ...
    /**
     * Simple test to ensure we can scan using SRU bridge
     */
    public void testSimpleScan()
    {
        ...
        {
            // create the binding
            SRUBinding binding = new SRUBinding("http://tweed.lib.ed.ac.uk:8080/elf/search/oxford");
            // create the query
            QueryBuilder builder = new QueryBuilder();
            Node query = builder.getNode("author", "thomas");
            String cql = new CQLQuery(new JaferQuery((Node) query)).getCQLQuery();
    ...
    /**
     * Simple test to ensure we can search and retreive records using SRU bridge
     */
    ...
    /**
     * Simple test to ensure we can search using SRU bridge and diagnostic
     * returned
     */
    ...
    public void testNonExistantURLOnSearch()
    {
        ...
        {
            // create the binding
            SRUBinding binding = new SRUBinding("http://loc.gov:7090/voyager");
            // create the query
            QueryBuilder builder = new QueryBuilder();
            Node query = builder.getNode("author", "thomas");
            String cql = new CQLQuery(new JaferQuery((Node) query)).getCQLQuery();
    ...
    /**
     * Test bad version when performing search using SRU bridge
     */
    public void testBadVersionSearch()
    {
        try
        {
            // create the binding
    ...
    /**
     * Test bad version when performing scan using SRU bridge
     */
    public void testBadVersionScan()
    {
        try
        {
            // create the binding
